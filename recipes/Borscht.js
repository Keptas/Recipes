    ...
    return (
        Recipes.map( recipe => {
          return(
            ...
            <Text style={styles.titleText} > {recipe.nameBorscht} </Text>
            <Image source={{uri: recipe.imageUrlBorscht }} 
            style={styles.image} />
            <Text style={styles.text} > Ingredients </Text>
            <Text>{recipe.ingredientsBorscht}</Text>
            <Text style={styles.text} > Steps </Text>
            <Text>{recipe.stepsBorscht}</Text>
            </ScrollView>
          )
          }
