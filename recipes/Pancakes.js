    ...
    return (
        Recipes.map( recipe => {
          return(
            ...
            <Text style={styles.titleText} > {recipe.namePancakes} </Text>
            <Image source={{uri: recipe.imageUrlPancakes }} 
            style={styles.image} />
            <Text style={styles.text} > Ingredients </Text>
            <Text>{recipe.ingredientsPancakes}</Text>
            <Text style={styles.text} > Steps </Text>
            <Text>{recipe.stepsPancakes}</Text>
            </ScrollView>
          )
          }
