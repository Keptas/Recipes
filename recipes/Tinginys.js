    ...
    return (
        Recipes.map( recipe => {
          return(
            ...
            <Text style={styles.titleText} > {recipe.nameTinginys} </Text>
            <Image source={{uri: recipe.imageUrlTinginys }} 
            style={styles.image} />
            <Text style={styles.text} > Ingredients </Text>
            <Text>{recipe.ingredientsTinginys}</Text>
            <Text style={styles.text} > Steps </Text>
            <Text>{recipe.stepsTinginys}</Text>
            </ScrollView>
          )
          }
